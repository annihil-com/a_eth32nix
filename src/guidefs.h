...
// NOTE: you can add your window to a category in the function: CGui::Init(void);
	...
	},
	{
		...
		3,
		{
			{ CTRL_DROPBOX,		"Aimbot Mode", 		5, 5,	140,	23,		0, AIMMODE_MAX-1, (int)&eth32.settings.aimMode, (int)aimModeText },
            		{ CTRL_FLOATSLIDER,	"Human-Aim-Speed",		5,		33,	140,	20,		SETFLOAT(-0.00), SETFLOAT(0.20), (int)&eth32.settings.humanPredict },
            		{ CTRL_CHECKBOX, "Aim before shoot", 5, 63, 140, 8, (int)&eth32.settings.preAim },
