...
const static settingdef_t settingsDefs[] =
{
	...
	{ "humanPredict",		"0.3",		SETTING_FLOAT,		(void*)&eth32.settings.humanPredict,
		 "Human AIM Prediction",
 	},

 	/*{ "humanWithDiv",		"false",		SETTING_BOOL,		(void*)&eth32.settings.humanWithDiv,
		 "Human Div-Max thing...",
 	},

 	{ "humanDivMax",		"1.9",		SETTING_FLOAT,		(void*)&eth32.settings.humanDivMax,
		 "Human Div-Max thing...",
 	},

 	{ "humanDivMin",		"0.0",		SETTING_FLOAT,		(void*)&eth32.settings.humanDivMin,
		 "Human Div-Min thing...",
 	},*/
